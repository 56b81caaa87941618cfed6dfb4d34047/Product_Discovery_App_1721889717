...
*/
Vue.component("simple_footer_component_1721889719", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Unlock a world of exciting new products right at your fingertips. From the latest gadgets to trendy fashion items, Discover keeps you ahead of the curve. Download now and start exploring!
                    </div>
                </div>
            </div>
        </footer> 
